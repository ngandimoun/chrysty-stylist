...
export function buildNearbyExcerpt(fullText, selection, maxChars = 1600) {
...
export function resolveCaptureElement(captureTarget) {
    ...
    return document.querySelector('[data-chrysty-capture]');
}
export async function captureElement(captureTarget) {
