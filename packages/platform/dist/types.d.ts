...
export type ActionType = "chat_message" | "ai_completion" | "document_generation" | "workflow_execution" | "search_request";
...
export type CheckAccessResponse = {
    allowed: boolean;
    reason?: "no_subscription" | "worker_not_included" | "quota_exceeded" | "past_due";
    remaining?: {
        actions: number;
        tokens: number;
    };
